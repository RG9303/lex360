...
import { ChevronLeft, Scale, ArrowRight, ShieldCheck, Landmark, Gavel, FileText } from 'lucide-react';
import { abogados } from '@/data/abogados';
import React from 'react';

export default function AbogadoProfilePage({ params }: { params: { slug: string } }) {
                    ...
                    >
                        ...
                        <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 items-start">
                            ...
                            <div className="lg:col-span-4 hidden lg:block">
                                <div className="glass-card bg-white/5 border border-white/10 p-12 rounded-[3rem] text-center shadow-2xl relative">
                                    <div className="absolute -top-10 -left-10 w-40 h-40 bg-gold/10 rounded-full blur-3xl"></div>
                                    <div className="w-20 h-20 bg-gold/20 rounded-2xl mx-auto flex items-center justify-center text-gold mb-8 rotate-12">
                                        <Scale size={40} />
                                    </div>
                                    ...
                                    <button className="w-full bg-gold text-primary font-black py-4 rounded-full text-xs uppercase tracking-widest hover:bg-white transition-all shadow-xl">
                                        Agendar consulta
                                    </button>
                                </div>
                            </div>
                        ...
                        <div className="sticky top-32 space-y-12">
                            ...
                            <div className="p-1 w-full bg-gradient-to-r from-gold/20 to-transparent rounded-[2rem]">
                                <div className="bg-slate-950 p-10 rounded-[2rem] border border-white/5">
                                    ...
                                    <button className="group flex items-center gap-3 text-gold font-black text-xs uppercase tracking-widest hover:gap-5 transition-all">
